...
namespace WindowsFormsApplication1 {
    ...
    public partial class ClienteDataSet : global::System.Data.DataSet {
        ...
        public partial class clienteDataTable : global::System.Data.TypedTableBase<clienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public clienteRow AddclienteRow(string nome, string profissao, string nacionalidade, int idade, string endereco) {
...
namespace WindowsFormsApplication1.ClienteDataSetTableAdapters {
    ...
    public partial class clienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[cliente] WHERE (([Id] = @Original_Id) AND ([nome] = @Original_" +
                "nome) AND ([profissao] = @Original_profissao) AND ([nacionalidade] = @Original_n" +
                "acionalidade) AND ([idade] = @Original_idade) AND ([endereco] = @Original_endere" +
                "co))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[cliente] ([nome], [profissao], [nacionalidade], [idade], [ende" +
                "reco]) VALUES (@nome, @profissao, @nacionalidade, @idade, @endereco);\r\nSELECT Id" +
                ", nome, profissao, nacionalidade, idade, endereco FROM cliente WHERE (Id = SCOPE" +
                "_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[cliente] SET [nome] = @nome, [profissao] = @profissao, [nacionalidade] = @nacionalidade, [idade] = @idade, [endereco] = @endereco WHERE (([Id] = @Original_Id) AND ([nome] = @Original_nome) AND ([profissao] = @Original_profissao) AND ([nacionalidade] = @Original_nacionalidade) AND ([idade] = @Original_idade) AND ([endereco] = @Original_endereco));
SELECT Id, nome, profissao, nacionalidade, idade, endereco FROM cliente WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication1.Properties.Settings.Default.ClienteConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, nome, profissao, nacionalidade, idade, endereco FROM dbo.cliente";
        ...
        public virtual int Fill(ClienteDataSet.clienteDataTable dataTable) {
        ...
        public virtual ClienteDataSet.clienteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ClienteDataSet.clienteDataTable dataTable = new ClienteDataSet.clienteDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ClienteDataSet.clienteDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_nome, string Original_profissao, string Original_nacionalidade, int Original_idade, string Original_endereco) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_idade));
        ...
        public virtual int Insert(string nome, string profissao, string nacionalidade, int idade, string endereco) {
            if ((nome == null)) {
        ...
        public virtual int Update(string nome, string profissao, string nacionalidade, int idade, string endereco, int Original_Id, string Original_nome, string Original_profissao, string Original_nacionalidade, int Original_idade, string Original_endereco, int Id) {
            if ((nome == null)) {
                throw new global::System.ArgumentNullException("nome");
            }
            else {
            ...
            if ((Original_profissao == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_profissao));
            }
            if ((Original_nacionalidade == null)) {
                throw new global::System.ArgumentNullException("Original_nacionalidade");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nome, string profissao, string nacionalidade, int idade, string endereco, int Original_Id, string Original_nome, string Original_profissao, string Original_nacionalidade, int Original_idade, string Original_endereco) {
            return this.Update(nome, profissao, nacionalidade, idade, endereco, Original_Id, Original_nome, Original_profissao, Original_nacionalidade, Original_idade, Original_endereco, Original_Id);
        }
    }
